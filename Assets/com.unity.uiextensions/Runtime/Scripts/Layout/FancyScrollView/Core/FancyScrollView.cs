...
namespace UnityEngine.UI.Extensions
{
    ...
    public abstract class FancyScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        ...
        public List<GameObject> CellObjectList = new List<GameObject>();
        /// <summary>
        /// 初期化済みかどうか.
        /// </summary>
        ...
        /// セルのレイアウトを強制的に更新します.
        /// </summary>
        protected virtual void Relayout() => UpdatePosition(currentPosition, true);
        ...
        protected virtual void UpdatePosition(float position) => UpdatePosition(position, true);
        ...
        void ResizePool(float firstPosition)
        {
            ...
            //    CellObjectList.Add(cell.gameObject);
            //    if (cell == null)
            //    {
            ...
            {
                Transform childTransform = contentPanel.GetChild(i);
                var cell =childTransform.GetComponent<FancyCell<TItemData, TContext>>();
                cell.SetContext(Context);
                cell.Initialize();
