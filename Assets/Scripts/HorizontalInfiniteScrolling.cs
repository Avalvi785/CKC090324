...
namespace UnityEngine.UI.Extensions
{
    ...
    public class HorizontalInfiniteScrolling: MonoBehaviour
    {
        ...
        private void Scroll(int direction)
        {
            if (_scrollRect != null)
            {
                float targetX = _scrollRect.content.anchoredPosition.x + direction * _recordOffsetX;
                Vector2 newAnchoredPosition = Vector2.Lerp(_scrollRect.content.anchoredPosition, new Vector2(targetX, 0f), Time.deltaTime * 70);
                _scrollRect.content.anchoredPosition = newAnchoredPosition;

                // Call OnScroll method to handle infinite scrolling logic
        ...
        // Method to scroll to the right when the right button is clicked
